...
Bracken Warden은 Area 1 보스 — 보스 아레나 (Round 4-4 cols 41-42) 뒷벽의
무릎 꿇은 이끼-돌 거인. 사양 출처: `docs/briefs/phase3-boss-cast.md`.
스프라이트는 보스 브리프 §3의 FSM 6개 상태를 모두 보낸다: `idle`, `windup`,
`attack`, `recover`, `hurt`, `dead`.
